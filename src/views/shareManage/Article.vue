    ...
    <div v-show="!dialogFormVisible">
      <query ref="querycomponent" :list-query="listQuery" :api="api">
        <div slot="queryFilter">
          ...
          <el-select v-model="listQuery.type" size="small" clearable class="filter-item" placeholder="所属模块">
            <el-option v-for="(it, index) in typedata" :key="index" :label="it.label" :value="it.value"/>
          </el-select>
        ...
        <el-table-column slot="tableColumn" :label="$t('table.module')" :formatter="typeformate" prop="type" align="center"/>
    ...
    <div v-show="dialogFormVisible" class="app-container">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="80px" style="width: 100%;">
        ...
        <el-form-item :label="$t('table.type')">
          <el-select v-model="temp.type" size="small">
            <el-option v-for="(it, index) in typedata" :key="index" :label="it.label" :value="it.value"/>
          </el-select>
        </el-form-item>
